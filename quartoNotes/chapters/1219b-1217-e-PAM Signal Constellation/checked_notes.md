...
>
> 解调则是其逆过程，但难点在于**如何在加性高斯白噪声（AWGN）干扰下准确恢复原始符号**——这引出了 **“误码率”** 和 **“抗干扰能力”** 的设计权衡问题。
...
> 注意：上门这个PPT中的$E_{avg}$是$u_k$等概率时的情形
...
> - 这后续可以结合信源编码中的霍夫曼编码思想进行优化：高频符号用短码（低能量），低频符号用长码（高能量）以降低总体开销。
